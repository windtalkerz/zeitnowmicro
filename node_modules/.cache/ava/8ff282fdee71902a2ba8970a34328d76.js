...
test(url, async t => {
    ...
    };const response = await axios.get(`${url}/?name=mario`, { name: "peach" });
    const { character } = await response.data;
    t.deepEqual(character, mario);
});
//# sourceMappingURL=/Users/mac/Desktop/zeitnowmicro/node_modules/.cache/ava/8ff282fdee71902a2ba8970a34328d76.js.map